...
- **Demo**: `PYTHONPATH=src python experiments/hello_world/run.py`
- **Template**: copy `experiments/experiment_template.py` for new experiments
- **Reports**: timestamped HTML+JSON in `experiments/reports/`, self-contained with inline D3.js
